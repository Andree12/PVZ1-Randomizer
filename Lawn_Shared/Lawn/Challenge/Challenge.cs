...
namespace Lawn
{
    public/*internal*/ class Challenge : StoreListener
    {
        ...
        public void UpdateConveyorBelt()
        {
            ...
            int num2 = 0;
            int cherrybomb_num = (int)SeedType.Cherrybomb;
            int wallnut_num = (int)SeedType.Wallnut;
            int potatomine_num = (int)SeedType.Potatomine;
            int snowpea_num = (int)SeedType.Snowpea;
            int chomper_num = (int)SeedType.Chomper;
            int repeater_num = (int)SeedType.Repeater;
            int puffshroom_num = (int)SeedType.Puffshroom;
            int fumeshroom_num = (int)SeedType.Fumeshroom;
            int gravebuster_num = (int)SeedType.Gravebuster;
            int hypnoshroom_num = (int)SeedType.Hypnoshroom;
            int scaredyshroom_num = (int)SeedType.Scaredyshroom;
            int iceshroom_num = (int)SeedType.Iceshroom;
            int doomshroom_num = (int)SeedType.Doomshroom;
            int squash_num = (int)SeedType.Squash;
            int threepeater_num = (int)SeedType.Threepeater;
            int tanglekelp_num = (int)SeedType.Tanglekelp;
            int jalapeno_num = (int)SeedType.Jalapeno;
            int spikeweed_num = (int)SeedType.Spikeweed;
            int torchwood_num = (int)SeedType.Torchwood;
            int tallnut_num = (int)SeedType.Tallnut;
            int seashroom_num = (int)SeedType.Seashroom;
            int plantern_num = (int)SeedType.Plantern;
            int cactus_num = (int)SeedType.Cactus;
            int blover_num = (int)SeedType.Blover;
            int splitpea_num = (int)SeedType.Splitpea;
            int starfruit_num = (int)SeedType.Starfruit;
            int pumpkin_num = (int)SeedType.Pumpkinshell;
            int magnetshroom_num = (int)SeedType.Magnetshroom;
            int cabbagepult_num = (int)SeedType.Cabbagepult;
            int flowerpot_num = (int)SeedType.Flowerpot;
            int kernelpult_num = (int)SeedType.Kernelpult;
            int coffeebean_num = (int)SeedType.InstantCoffee;
            int garlic_num = (int)SeedType.Garlic;
